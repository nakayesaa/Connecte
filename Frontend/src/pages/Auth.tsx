...
import { GithubIcon, Users } from "lucide-react";
      ...
      <div className="w-full max-w-lg">
        ...
        <Tabs defaultValue="login" className="w-full">
          <TabsList className="grid w-full grid-cols-2 text-slate-900">
            <TabsTrigger value="login" className="bg-blue-950">Login</TabsTrigger>
            <TabsTrigger value="signup" className="bg-blue-950">Sign Up</TabsTrigger>
          </TabsList>
          <TabsContent value="login">
            ...
            <div className="flex justify-center gap-4">
              <Button className="bg-white max-w-sm">
                <GithubIcon className="text-slate-800"></GithubIcon>
          ...
          <TabsContent value="signup">
            <form onSubmit={registerUser} className="space-y-4">
              ...
              <Button type="submit" className="w-full bg-gray-600 text-white">submit</Button>
            </form>
          </TabsContent>
        </Tabs>
      </div>
