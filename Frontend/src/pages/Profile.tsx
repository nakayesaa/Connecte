...
const Profile = ()=>{
    ...
    return(
            ...
            <div className="container flex h-16 items-center justify-between relative">
                <Link to="/" className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-xs text-muted-foreground">Where Engineers Gather</span>
                    </div>
                </Link>
                    <div className="absolute left-1/2 transform -translate-x-1/2 flex gap-4">
                        ...
                        <Compass className="h-5 w-5 text-muted-foreground"/> Discover </button>
        ...
        <main className="container py-12">
            ...
            <div className="text-muted-foreground text-center mb-8">Flex Yourself</div>
            ...
            <div className="space-y-5">
                <div>
                    <div className="text-sm font-medium text-slate-700"> University </div>
                    <Input
                ...
                <div>
                <div className="text-sm font-medium text-slate-700"> Portfolio/Website </div>
                <Input
                    value={data.portfolo || ""}
                    disabled={!change}
                    ...
                    data.Posts.map((post:any)=>(
                        ...
                        <div className="flex justify-between items-start">
                            ...
                            <div className="mt-3 flex flex-wrap gap-2">
                                {post.role && ( <span className="bg-blue-50 text-blue-700 px-3 py-1 text-xs rounded-full">{post.role}</span>)}
                            </div>
                            </div>
                        </div>
                        <div className="flex items-center gap-3 mt-6">
                            ...
                            <div>
                                ...
                                <div className="text-xs text-muted-foreground">{data.university || "No university"}</div>
